...
Let's make tests for the estimate (4.1). The estimate (4.2) is a consequence of the estimate (4.1) that's why following tests prove (4.2) too.
...
\begin{figure}[h]
\center{\includegraphics[scale=0.5]{tests/Examples.png}}
...
We can see that there are tests points under this line. It proves our estimates (4.1) and (4.2).
