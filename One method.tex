...
If a modulus of continuity $\omega(f'_y, \delta_0)$($\omega(f'_y, \delta_0)$) on a horizontal (vertical) segment $E$ meet the condition \eqref{C3}(the condition \eqref{C4}) and possible error less than $\delta_0$ then rectangle is selected correctly.
\end{theorem}
\begin{proof}
