...
In the paper~\cite{Ston_Pas} there are some results for this method. In this paper we want to continue this research.
...
\bibitem{my_git}
Repository with code: \href{https://github.com/ASEDOS999/Optimization-Halving-The-Square/tree/master/Tests}{this repository}
\end{thebibliography}
\end{document}
