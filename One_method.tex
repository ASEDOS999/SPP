...
\caption{Comparison of different optimization methods on saddle point task for prime task with dimension: \subref{10}  $N=10$; \subref{100} $N=10$.} \label{fig:image}
\end{figure}
