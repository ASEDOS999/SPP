...
This experiment showed that our method is more effective on some dual task than the classic methods such as gradient descent and ellipsoid method. Additionally, our method an estimate through current gradient is faster than with constant estimate.
