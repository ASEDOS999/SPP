...
\begin{figure}[ht!]  
\vspace{-4ex} \centering \subfigure[]{
\includegraphics[width=0.25\linewidth]{Tests/Images/10_1e-1.pdf} \label{10_1} }  
\hspace{2ex}
\subfigure[]{
\includegraphics[width=0.25\linewidth]{Tests/Images/10_1e-3.pdf} \label{10_3} }
\hspace{2ex}
\subfigure[]{ \includegraphics[width=0.25\linewidth]{Tests/Images/10_1e-10.pdf} \label{10_10} }  
\vspace{2ex}
\subfigure[]{
\includegraphics[width=0.25\linewidth]{Tests/Images/100_1e-1.pdf} \label{100_1} }  
\hspace{2ex}
\subfigure[]{
\includegraphics[width=0.25\linewidth]{Tests/Images/100_1e-3.pdf} \label{100_3} }
\hspace{2ex}
...
Let's compare out method with inexact ellipsoid method and primal gradient method with $(\delta, L,\mu)$ oracle (see previous subsection \ref{Inexact}) on a dual task.
...
\begin{itemize}
\item If $f$ is a convex function with $L$-Lipschitz continious gradient then
$$\|f(\textbf{x}_k)-f(\textbf{x}^*)\|\leq \frac{\|\textbf{x}_0-\textbf{x}^*\|}{k}$$
\item If $f$ is a $\mu$-strong convex function with $L$-Lipschitz continious gradient then
$$\|f(\textbf{x}_k)-f(\textbf{x}^*)\|\leq \left(\frac{M-1}{M+1}\right)^kL\|\textbf{x}_0-\textbf{x}^*\|,$$
where $M =\frac{L}{\mu}$.
\end{itemize}
For all inexact method we will calculate $x(\lambda)$ with such accuracy as the method will converge to the solution with same for all methods accuracy $\epsilon$
