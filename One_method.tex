...
$$\dots$$
If the left part is positive it is constant $M$ from theorem 3.2 and it can be used in theorem 3.1.

Secondly, we can replace the Lipschitz condition on the square by the Lipschitz condition on the segments in the theorem 3.2. Similarly, we can replace condition for the second derivative in theorem 3.1. 
