...
The third having to be discussed method is inexact ellipsoid method. The ellipsoid method with $\epsilon$-subgradient instead usual subgradient converges to a solution with accuracy $\epsilon$. It is proved in \cite{Ellipsoids}. Moreover, in \cite{Polyak} there is proved that for the function
